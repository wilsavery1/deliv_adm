                    ...
                    @endforeach
                        ...
                        <div class="mb-20">
                            ...
                            <select class="js-select form-control w-100 promotion_type" name="advertisement_type">
                                ...
                                <option value="store_promotion" {{ $advertisement?->add_type == 'store_promotion' ? 'selected' : '' }} >{{ $isProviderContext ? translate('provider') . ' ' . translate('promotion') : translate('store_promotion') }}</option>
                            </select>
                        </div>
                        <div class="mb-20">
