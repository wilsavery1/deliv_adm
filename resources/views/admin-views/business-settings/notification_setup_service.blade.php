    ...
    <div class="content container-fluid">
        ...
        <div class="page-header d-flex flex-wrap align-items-center justify-content-between">
            ...
            <ul class="nav nav-tabs border-0 nav--tabs nav--pills mb-4">
                <li class="nav-item">
                    <a class="nav-link {{ request()?->type == null || request()?->type == 'admin' ?  'active' : '' }} " href="{{ route('admin.business-settings.notification_setup' ,[ 'module' => 'service', 'type' =>  'admin'])  }}">{{ translate('Admin') }}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{  request()?->type == 'provider' ?  'active' : '' }} " href="{{ route('admin.business-settings.notification_setup' ,[ 'module' => 'service', 'type' =>  'provider'])  }}">{{ translate('provider') }}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ request()?->type == 'customers' ?  'active' : '' }}"   href="{{ route('admin.business-settings.notification_setup' ,[ 'module' => 'service', 'type' =>  'customers'])  }}">{{ translate('Customers') }}</a>
                </li>
