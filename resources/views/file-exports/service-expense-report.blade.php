<div class="row">
    <div class="col-lg-12 text-center"><h1>{{ translate('service_expense_reports') }}</h1></div>
    <div class="col-lg-12">
        <table>
            <thead>
                <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @elseif(isset($exp?->serviceBooking?->user_info['contact_person_name']))
                                {{ $exp?->serviceBooking?->user_info['contact_person_name'] }}
                            @else
