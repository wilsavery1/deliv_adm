<div class="custom-offcanvas-header bg--secondary d-flex justify-content-between align-items-center px-3 py-3">
    <h3 class="mb-0">{{ translate('messages.Employee Role') }}</h3>
    <button type="button"
...
<div class="custom-offcanvas-body p-20">
    ...
    @php($permissions = json_decode($role->modules, true) ?? [])
    <h5 class="fs-16 mb-3">
...
<div class="offcanvas-footer p-3 d-flex align-items-center justify-content-center gap-3">
    ...
    <a type="button" href="{{ route('vendor.custom-role.edit', [$role['id']]) }}" class="btn w-100 btn--primary">{{ translate('messages.Edit Details') }}</a>
</div>
