...
namespace App\Library\Pagadito;
 ...
 *
 * Adapted for Laravel: namespaced and given exec_trans_url() so the checkout
 * URL can be returned to the framework instead of performing a header redirect.
 */
class Pagadito
{
    //*********************************** Atributos
    ...
    /**
     * Solicita el registro de la transacción y devuelve la URL de la pantalla
     * de cobros de Pagadito (PG1002). En caso de error devuelve false.
     *
     * Reemplazo compatible con Laravel para exec_trans(): en lugar de emitir un
     * header("Location: ...") y exit(), retorna la URL para que el controlador
     * pueda usar redirect()->away($url).
     *
