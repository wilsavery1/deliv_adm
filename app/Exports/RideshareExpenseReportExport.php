...
class RideshareExpenseReportExport implements FromView, ShouldAutoSize, WithStyles, WithColumnWidths, WithHeadings, WithEvents
{
    use Exportable;
    protected $data;
    ...
    {
        return view('file-exports.rideshare-expense-report', [
            'data' => $this->data,
        ]);
    }
