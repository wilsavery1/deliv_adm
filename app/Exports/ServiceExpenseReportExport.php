...
class ServiceExpenseReportExport implements FromView, ShouldAutoSize, WithStyles, WithColumnWidths, WithHeadings, WithEvents
{
    use Exportable;
    protected $data;
    ...
    {
        return view('file-exports.service-expense-report', [
            'data' => $this->data,
        ]);
    }
