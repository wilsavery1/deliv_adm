...
class AdminEarningTransactionExport implements FromView, ShouldAutoSize, WithStyles, WithColumnWidths, WithHeadings, WithEvents
{
    use Exportable;
    protected $data;
    ...
    {
        return view('file-exports.admin-earning-transaction', [
            'data' => $this->data,
        ]);
    }
