...
class VendorLoginController extends Controller
{
    ...
    public function register(Request $request)
    {
        ...
        try{
            ...
            if($module?->module_type != 'rental' && $module?->module_type != 'service' && config('mail.status') && $mail_status == '1' &&  Helpers::getNotificationStatusData('store','store_registration','mail_status')){
            ...
            if($module?->module_type != 'rental' && $module?->module_type != 'service' && config('mail.status') && $mail_status == '1' &&  Helpers::getNotificationStatusData('admin','store_self_registration','mail_status')){
